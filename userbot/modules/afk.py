...
AFKSTR = [
    ...
    "`Bu nömrəyə zəng çatmır. Telefon ya söndürülüb yada əhatə dairəsi xaricindədi. Zəhmət yenidən cəhd edin.` \n`biiiiiiiiiiiiiiiiiiiiiiiiiiiiip`!",
    "`Bir neçə dəqiqə içində gəcəyəm. Ancaq gəlməsəm...\ndaha çox gözlə.`",
    ...
    "`Hələdə anlamadınsa,\nburada deyiləm.`",
    "`Aləm qalxsa səni məni məndən alnağa hamıdan alıb götürrəm səni.../nSahibim burada deil ama qruza salacaq mahnılar oxuya bilərəm 😓🚬`",
