#Copy That Plugin by @umudmmmdov1
...
CMD_HELP.update({
    "klon":
    ".klon <mesaja cavab olaraq yazmaq ya da istifadəçi adı>. \nİşlədilişi: Cavab verdiyiniz istifadəçinin klonu olursuz"})
